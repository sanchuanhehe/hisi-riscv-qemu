...
I2C_ELF="$TARGET_DIR/bs20_i2c_scan"
if [ -f "$I2C_ELF" ]; then
    echo "==> bs20 i2c_scan on -M bs20: expecting a bus scan to find I2C0 slave 0x50"
    timeout 6 "$QEMU_BIN" -M bs20 -nographic -serial mon:stdio \
